...
export class ListadoPage {
  ...
  changeMonthTitle(){
    if(this.evento){
      this.rect1 = document.getElementById("article1").getBoundingClientRect();
      this.rect2 = document.getElementById("article2").getBoundingClientRect();
      this.rect3 = document.getElementById("article3").getBoundingClientRect();
      this.rect4 = document.getElementById("article4").getBoundingClientRect();
